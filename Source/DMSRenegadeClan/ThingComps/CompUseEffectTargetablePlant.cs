...
namespace DMSRC
{
	...
	public class CompUseEffectTargetablePlant : CompUseEffect, ITargetingSource
	{
		...
		{
			base.PostPostMake();
			hoursCooldownSelected = Props.timerRange.Average;
		}
		...
		public override IEnumerable<Gizmo> CompGetGizmosExtra()
		{
			...
			command_Action.defaultLabel = "DMSRC_DecreaseTimer".Translate(hoursCooldownSelected.ToString("F1"));
			command_Action.defaultDesc = "DMSRC_DecreaseTimer".Translate(hoursCooldownSelected.ToString("F1"));
			...
			{
				hoursCooldownSelected = Mathf.Min(hoursCooldownSelected + 0.1f, Props.timerRange.max);
			};
			command_Action2.defaultLabel = "DMSRC_IncreaseTimer".Translate(hoursCooldownSelected.ToString("F1"));
			command_Action2.defaultDesc = "DMSRC_IncreaseTimer".Translate(hoursCooldownSelected.ToString("F1"));
