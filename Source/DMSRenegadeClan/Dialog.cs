...
namespace DMSRC
{
	public class Dialog_OverseerRechargeSettings : Window
	{
		...
		public Dialog_OverseerRechargeSettings(CompOverseerMech comp)
		{
			this.comp = comp;
			range = new FloatRange(comp.minCharge, comp.maxCharge);
		...
		public override void DoWindowContents(Rect inRect)
		{
			...
			{
				comp.minCharge = range.min;
				comp.maxCharge = range.max;
				Close();
			}
		}
	}
